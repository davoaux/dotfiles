 ...
 *6)emptycol         */
static const char *colors[] = {"#141414","#141414","#458588","#fb4934","#cc9933","#333333","#000000"};
...
static const char *vol_up[]    = { "amixer", "set", "Master", "unmute", "4%+", "-q", NULL };
static const char *vol_down[]  = { "amixer", "set", "Master", "unmute", "4%-", "-q", NULL };
static const char *vol_toggle[]  = { "amixer", "set", "Master", "toggle", "-q", NULL };
static const char *powermenu[]  = { "powermenu", NULL };
static const char *popup[]  = { "popup", NULL };
static const char *scrotf[]  = { "prtscr", "-f", NULL };
static const char *scrot[]  = { "prtscr", NULL };
